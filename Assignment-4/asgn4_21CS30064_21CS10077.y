...
primary_expression:
                    ...
                    | integer_constant {printf(" primary_expression -> integer_constant : %d\n", $1);}
                    | floating_constant {printf(" primary_expression -> floating_constant : %f\n", $1);}
                    | character_constant {printf(" primary_expression -> character_constant : %s\n", $1);}
